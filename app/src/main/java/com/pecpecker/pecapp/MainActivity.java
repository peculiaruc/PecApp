...
import com.pecpecker.pecapp.models.FragmentTag;
import com.pecpecker.pecapp.models.Message;
import com.pecpecker.pecapp.models.User;
import com.pecpecker.pecapp.settings.SettingsFragment;
...
public class MainActivity extends AppCompatActivity implements IMainActivity, BottomNavigationView.OnNavigationItemSelectedListener,
    ...
    //widgets
    private BottomNavigationView mBottomNavigationViewEx;
...
//        super.onBackPressed();
    ...
    private void isFirstLogin() {
        ...
        if (isFirstLogin) {
            ...
            alertDialogBuilder.setIcon(R.drawable.data_logo);
